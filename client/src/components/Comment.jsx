...
import {BOOK_ROUTE, STATIC_FILE_URL, USER_ROUTE} from '../utils/consts'
...
const Comment = observer( ({com, Update, ObjId, isCreated}) => {
    ...
    return (
        <div className='m-2 me-0'>
            ...
            <Image width={48} height={48} src={STATIC_FILE_URL + (com.user.icon ? com.user.icon : 'iconNotFound.png')} className='rounded-circle me-2'/>
