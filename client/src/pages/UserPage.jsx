...
import {ACCOUNT_ROUTE, STATIC_FILE_URL} from "../utils/consts";
...
const UserPage = ({}) => {
    ...
    return (
        <div className='d-flex ms-4 me-4'>
            ...
            <div className='W-100'>
                <div className='W-100'>
                    <Image className='img-fluid' src={STATIC_FILE_URL + 'defaultUB.jpg'}/>
                </div>
                ...
                <div className='W-100 Block'>
                    ...
                    <Image
                        ...
                        width={200} height={200} src={STATIC_FILE_URL+UserLogo}/>
