...
import iconEyeClose from "../assets/EyeClose.svg";
        ...
        <Card style={{width: 600}} className='p-5'>
          ...
          <Form className='d-flex flex-column'>
            ...
            <div className="d-flex mt-3">
              ...
              />
                <div>
                    <Button variant={'outline-secondary' } className='m-0 p-0' onClick={() => setShowPassword((prev) => (!prev) )}>
                        <img src={ !showPassword ? iconEyeOpen : iconEyeClose} className="ms-auto" style={{ }}/>
                    </Button>
                </div>
